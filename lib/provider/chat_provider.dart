...
import '../views/material/profile_screen/components/text_fields.dart';
import '../views/material/profile_screen/profile.dart';

class ChatProvider extends ChangeNotifier {
  List<PersonlDataModel> personData = [];

  void addData(PersonlDataModel data) {
    personData.add(data);
    notifyListeners();
  }
  ...
  void updateData(int index, PersonlDataModel updatedData) {
